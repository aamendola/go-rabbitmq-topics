...
func (c Client) StartConsuming(consumer Consumer) {
	...
	if c.endless {
		log.Printf("[*] Aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa")
		...
		log.Printf("[*] Bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb")
		c.pp(consumer, deliveries, channel, keys)
	}
}
